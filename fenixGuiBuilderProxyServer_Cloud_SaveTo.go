...
func (fenixGuiBuilderProxyServerObject *fenixGuiBuilderProxyServerObjectStruct) prepareSavePinnedTestInstructionsAndTestContainersToCloudDB(pinnedTestInstructionsAndTestContainersMessage *fenixTestCaseBuilderServerGrpcApi.PinnedTestInstructionsAndTestContainersMessage) (returnMessage *fenixTestCaseBuilderServerGrpcApi.AckNackResponse) {
	...
	err = fenixGuiBuilderProxyServerObject.savePinnedTestInstructionsAndTestContainersToCloudDB(txn, pinnedTestInstructionsAndTestContainersMessage)
	if err != nil {
		...
		// fenixGuiBuilderProxyServerObject.stateProcessIncomingAndOutgoingMessage = true
...
func (fenixGuiBuilderProxyServerObject *fenixGuiBuilderProxyServerObjectStruct) savePinnedTestInstructionsAndTestContainersToCloudDB(dbTransaction pgx.Tx, pinnedTestInstructionsAndTestContainersMessage *fenixTestCaseBuilderServerGrpcApi.PinnedTestInstructionsAndTestContainersMessage) (err error) {
	...
	*/
	...
	sqlToExecute = sqlToExecute + fenixGuiBuilderProxyServerObject.generateSQLInsertValues(dataRowsToBeInsertedMultiType)
...
func (fenixGuiBuilderProxyServerObject *fenixGuiBuilderProxyServerObjectStruct) generateSQLInsertValues(testdata [][]interface{}) (sqlInsertValuesString string) {
...
func (fenixGuiBuilderProxyServerObject *fenixGuiBuilderProxyServerObjectStruct) generateSQLINArray(testdata []string) (sqlInsertValuesString string) {
